...
const routes: Routes = [
  {
    path: '', resolve: {MoneyResolver}, children: [
      {path: '', redirectTo: 'incomplete-transactions', pathMatch: 'full'},
      {
        path: 'incomplete-transactions', component: IncompleteEntriesComponent,
  ...
  {
    path: 'incorrect-config', component: IncorrectConfigComponent,
    resolve: {MobileHeaderResolver},
